...
public final class PlaceholderMediasoupBridge: MediaSFUNativeLoadableMediasoupBridge {
    private var lastLoadedRtpCapabilitiesJson: String?

    public init() {}

    public func load(routerRtpCapabilitiesJson: String) throws {
        lastLoadedRtpCapabilitiesJson = routerRtpCapabilitiesJson
    }

    public func currentRtpCapabilitiesJson() -> String? {
        lastLoadedRtpCapabilitiesJson
    }
