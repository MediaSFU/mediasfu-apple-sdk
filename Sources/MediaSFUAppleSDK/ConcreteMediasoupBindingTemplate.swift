...
public protocol ConcreteMediasoupNativeDevice {
    ...
    func rtpCapabilitiesJson() throws -> String?
...
public final class ConcreteMediasoupProducerBinding: MediaSFUAssumedLibmediasoupProducerBinding {
    ...
    public func getStatsJson() -> String? { nativeProducer.getStatsJson() }
}
...
public final class ConcreteMediasoupConsumerBinding: MediaSFUAssumedLibmediasoupConsumerBinding {
    ...
    public func getStatsJson() -> String? { nativeConsumer.getStatsJson() }
}

public final class LoadableConcreteMediasoupDeviceAdapter: MediaSFULoadableDeviceAdapter {
    private let nativeDevice: ConcreteMediasoupNativeDevice
    private let baseAdapter: MediaSFUDeviceAdapter

    public init(nativeDevice: ConcreteMediasoupNativeDevice, baseAdapter: MediaSFUDeviceAdapter) {
        self.nativeDevice = nativeDevice
        self.baseAdapter = baseAdapter
    }

    public func load(routerRtpCapabilitiesJson: String) throws {
        try nativeDevice.load(routerRtpCapabilitiesJson: routerRtpCapabilitiesJson)
    }

    public func currentRtpCapabilitiesJson() -> String? {
        try? nativeDevice.rtpCapabilitiesJson()
    }

    public func createSendTransport(params: [String : Any?]) throws -> MediaSFUSendTransportAdapter {
        try baseAdapter.createSendTransport(params: params)
    }

    public func createRecvTransport(params: [String : Any?]) throws -> MediaSFURecvTransportAdapter {
        try baseAdapter.createRecvTransport(params: params)
    }
}
...
public enum ConcreteMediasoupBindingTemplate {
    ...
    public static func makeInstallableAdapter(nativeDevice: ConcreteMediasoupNativeDevice) -> MediaSFUDeviceAdapter {
        LoadableConcreteMediasoupDeviceAdapter(
            nativeDevice: nativeDevice,
            baseAdapter: RealMediasoupBindingEngine.makeInstallableAdapter(binding: makeBinding(nativeDevice: nativeDevice))
        )
    }
}
